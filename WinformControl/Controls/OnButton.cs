...
namespace WinformControl.Controls
{
    ...
    {
        private Color _BackColor = Color.FromArgb(255, 51, 51);
        private Color _TextColor = Color.FromArgb(255, 255, 255);
        private Color _BorderColor = Color.FromArgb(255, 51, 51);
        StringFormat sf;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            TextRenderer.DrawText(g, "ON", this.Font, outerRect, _TextColor, Color.Transparent, TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter | TextFormatFlags.EndEllipsis);
        }
