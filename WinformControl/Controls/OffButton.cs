...
namespace WinformControl.Controls
{
    public class OffButton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            TextRenderer.DrawText(g, "OFF", this.Font, outerRect, _TextColor, Color.Transparent, TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter | TextFormatFlags.EndEllipsis);
        }
